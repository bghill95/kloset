...
const PATHS: Record<Category, string> = {
  ...
  dress: "M60 20 L140 20 L155 50 L160 160 L40 160 L45 50 Z",
  jacket:
  ...
  accessory: "M100 80 Q115 80 120 95 Q115 110 100 110 Q85 110 80 95 Q85 80 100 80 Z",
};
...
export const OUTLINE_HINTS: Record<Category, string> = {
  ...
  dress: "Lay the dress flat inside the outline",
  ...
  accessory: "Place the accessory inside the outline",
};
