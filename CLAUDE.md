...
- `npm run test:e2e` — Playwright (creates + wipes the settings, items, base_photos, outfits, wears, pins, pinterest_pins, preferences and trips tables on each run!)
...
- e2e wipes the settings, items, base_photos, outfits, wears, pins, pinterest_pins, preferences and trips tables — never point DATABASE_URL at data
